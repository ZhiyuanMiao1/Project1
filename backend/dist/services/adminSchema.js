...
const ensureAdminSchema = async () => {
  ...
  `);
    await addColumnIfMissing("ALTER TABLE mentor_payroll_profiles ADD COLUMN settlement_method ENUM('alipay','wechat','overseas') NOT NULL DEFAULT 'alipay' AFTER china_tax_resident");
    await (0, db_1.query)(`

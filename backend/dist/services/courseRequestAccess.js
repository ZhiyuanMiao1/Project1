...
exports.canMentorReadCourseRequest = void 0;
const db_1 = require("../db");
const safeStatus = (value) => (typeof value === 'string' ? value.trim().toLowerCase() : '');
const canMentorReadCourseRequest = async ({ requestId, studentUserId, mentorUserId, requestStatus, }) => {

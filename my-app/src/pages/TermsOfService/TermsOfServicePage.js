...
const TERMS_CONTENT = {
    ...
    sections: [
      {
        ...
        title: '1. 接受本条款',
        paragraphs: [
          '更新日期：2026 年 8 月 20 日。欢迎使用 Mentory。本服务条款是你与 Mentory 之间具有约束力的协议，适用于 Mentory 网站、在线课堂、消息、支付及其他相关服务。',
      ...
      },
      {
        ...
        paragraphs: [
          'Mentory 向学生提供导师服务，以及导师发现、课程需求发布、预约、沟通、在线课堂、课时管理和交易等相关功能。学生可以浏览合作导师资料并自主选择，也可以发布课程需求，由相关导师主动发出邀约；是否接受邀约由学生决定。具体功能可能因地区、账户类型或服务阶段而不同。',
          '学生确认预约后，由其选定的合作导师实际提供课程。导师是 Mentory 的独立服务合作方，不是 Mentory 的雇员、代理或合伙人；这不影响 Mentory 根据本条款向学生承担的服务提供、课时管理、改期、退款和投诉处理责任。',
          'Mentory 不会擅自更换学生已经选定的导师。若该导师无法按约提供课程，学生可以选择与原导师改期、自主选择其他导师，或按照适用规则申请退还相应课时或款项。',
        ],
      },
      {
        id: 'student-terms',
        ...
        bullets: [
          ...
          '及时确认实际课时；如记录不一致，通过 Mentory 提供的流程提出异议。',
        ],
      },
      {
        id: 'mentor-terms',
      ...
      },
      {
        ...
        title: '6. 预约、费用与支付',
        paragraphs: [
          '学生通过 Mentory 购买或充值导师服务课时。价格、币种、课时、优惠和费用明细以付款前展示的信息为准；Mentory 可委托第三方支付服务商处理付款和退款。',
          '钱包余额、优惠或服务额度应按展示的用途和有效期使用，除法律要求或相关规则明确允许外，不可转让或兑换现金。课程完成后，Mentory 将按照双方确认或最终核定的实际课时扣除余额。',
        ],
        note: '不要通过 Mentory 未支持的方式交换支付凭证。支付服务商可能另有条款；其支付页面将显示适用信息',
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '未经所有相关人员同意及适用法律允许，不得在 Mentory 之外录制、传播课堂或披露他人的个人信息。请勿在消息或课堂中发送不必要的敏感信息。',
        ],
      },
      {
        id: 'conduct',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Mentory 的品牌、界面、软件和服务内容受知识产权法律保护。除服务明确允许外，你不得复制、出售、再许可或制作衍生产品。若你认为相关内容侵犯你的权利，请通过本页联系方式提交具体说明。',
        ],
      },
      {
        id: 'reviews',
        title: '11. 评价与反馈',
        paragraphs: [
          '评价应基于真实课程体验，保持相关、客观且不包含报复、操纵或未经授权的个人信息。我们可依据服务规则拒绝发布或移除明显虚假、违法、无关或滥用性的评价。',
      ...
      },
      {
        ...
        title: '13. 服务保障与责任',
        paragraphs: [
          '我们会以合理的技能和谨慎提供导师服务及相关技术功能，但无法保证所有技术功能始终不中断或无错误，也无法保证实现每一项个人学习目标。学生应结合导师资料和自身需要自主选择导师；Mentory 仍按照本条款对约定服务承担责任。',
      ...
      },
      {
        ...
        title: '15. 争议解决与联系我们',
        paragraphs: [
          '如发生问题，请先通过 Mentory 客服与我们联系，我们会尝试以公平、及时的方式解决。双方仍可使用适用法律提供的消费者投诉、调解、仲裁或司法救济。本条款不剥夺你依法享有的强制性消费者权利。',
  ...
  en: {
    ...
    sections: [
      ...
      { id: 'platform', title: '3. Mentory’s services and role', paragraphs: ['Mentory provides mentor services to students, together with related features for mentor discovery, posting lesson requests, bookings, communication, online classrooms, lesson-hour management, and transactions. Students may browse cooperating mentor profiles and choose independently, or post a lesson request and receive invitations from relevant mentors; students decide whether to accept an invitation. Features may differ by region, account type, or service stage.', 'After a booking is confirmed, the selected cooperating mentor delivers the lesson. Mentors are independent service collaborators of Mentory, not Mentory employees, agents, or partners. This does not reduce Mentory’s responsibility under these Terms for providing the service, managing lesson hours, rescheduling, refunds, and complaint handling.', 'Mentory will not replace a mentor already selected by the student without the student’s agreement. If that mentor cannot provide the lesson as agreed, the student may reschedule with the same mentor, independently choose another mentor, or request the return of the relevant lesson hours or payment under the applicable rules.'] },
      { id: 'student-terms', title: '4. Student terms', lead: 'When posting a request, booking, or attending a lesson, students must:', bullets: ['Review the mentor profile, lesson description, schedule, price, and applicable cancellation rules before confirming;', 'Provide accurate information needed to meet the learning goal and attend at the agreed time;', 'Respect the mentor’s reasonable teaching arrangements, intellectual property, privacy, and classroom rules;', 'Use a lesson only for themselves or participants identified in the booking, and not resell or share access;', 'Confirm actual lesson hours promptly and use the process provided by Mentory to dispute a mismatch.'] },
      ...
      { id: 'booking-payment', title: '6. Bookings, fees, and payments', paragraphs: ['Students purchase or top up lesson hours for mentor services through Mentory. The price, currency, lesson hours, promotions, and fee breakdown displayed before payment control. Mentory may engage third-party payment providers to process payments and refunds.', 'Wallet balances, promotions, or service credits must be used for their stated purpose and validity period and, unless required by law or expressly allowed, cannot be transferred or redeemed for cash. After a lesson is completed, Mentory deducts the actual lesson hours confirmed by both sides or finally determined under the applicable process.'], note: 'Do not exchange payment credentials through channels unsupported by Mentory. A payment provider may have separate terms displayed on its payment page' },
      ...
      { id: 'disclaimers', title: '13. Service assurances and liability', paragraphs: ['We provide mentor services and related technology with reasonable skill and care, but cannot promise that every technical feature will always be uninterrupted or error-free, or guarantee every personal learning outcome. Students independently choose mentors based on profile information and their own needs; Mentory remains responsible for the agreed services under these Terms.', 'To the extent permitted by law, each party is responsible only for reasonably foreseeable loss directly caused by its breach. These Terms do not exclude or limit liability for fraud, willful misconduct, personal injury, or any other liability that cannot legally be excluded or limited.'] },

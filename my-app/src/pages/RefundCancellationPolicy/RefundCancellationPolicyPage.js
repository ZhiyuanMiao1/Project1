  ...
  'zh-CN': {
    ...
    sections: [
      ...
      },
      {
        ...
        example: {
          label: '示例',
          text: '假设固定课时费为 799 元/小时，购买 10 课时原价 7,990 元，因满足满 10 课时的优惠条件减免 1,000 元，实际支付 6,990 元。申请退回 6 课时后只保留 4 课时，不再满足该优惠条件：可退款金额 = 实付 6,990 元 − 保留课时费用（4 × 799 元）= 3,794 元',
        },
      },
      {
        id: 'processing',

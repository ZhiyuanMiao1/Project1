      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            ['用个人名片展示自己', '通过编辑个人名片展示教育经历、专业方向、擅长领域、可授课内容和个人介绍，帮助合适的学生更快了解你。'],
        ...
        },
        {
          ...
          paragraphs: [
            'Mentory 仍在持续成长。我们会根据学习者和导师的反馈改进导师发现与选择、沟通、课堂与服务体验，让跨地区、跨学科的知识连接更自然。',
          ],
      ...
      sections: [
        {
          ...
          paragraphs: [
            'Mentory 正在构建一个连接学习者与专业导师的在线学习平台。目前，平台已覆盖导师资料展示、课程需求发布、导师邀约与学生自主选择、沟通、在线课堂、交易记录与课程回顾等学习环节。',
        ...
        },
        {
          ...
          items: [
            ...
            ['企业与团队学习', '针对团队明确的学科或技能需求，试行导师邀约与自主选择、专题课程或线上分享，并共同定义验证目标'],

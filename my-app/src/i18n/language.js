...
const en = {
  ...
  'wallet.wechatTransferTitle': 'Pay with WeChat Merchant QR',
  'wallet.wechatTransferSubtitle': 'Add your StudentID as the payment note. Lesson hours are added after Mentory verifies receipt.',
  ...
  'wallet.wechatStepScan': 'Open WeChat Scan. On a phone, long-press the image to recognize it or save the QR code first.',
  'wallet.wechatStepAmount': 'Enter the exact amount shown above and verify the payee on the confirmation screen.',
  'wallet.wechatStepRemark': 'Tap “Add note” on the payment page, paste the StudentID shown below, and then complete payment.',
  'wallet.wechatRemark': 'Payment note (Important)',
  'wallet.wechatStudentIdUnavailable': 'Unable to load StudentID',
  'wallet.wechatCopyStudentId': 'Copy StudentID',
  'wallet.wechatCopy': 'Copy',
  'wallet.wechatCopied': 'Copied',
  'wallet.wechatPaymentNotice': 'If “Add note” is unavailable or you forgot the StudentID, do not pay again. Contact us through Help Center for manual assistance.',
